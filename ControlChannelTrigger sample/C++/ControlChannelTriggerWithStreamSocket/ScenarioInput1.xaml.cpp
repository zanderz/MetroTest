...
void ScenarioInput1::rootPage_OutputFrameLoaded(Object^ sender, Object^ e)
{
	...
	TextBlock^ bytesblock = dynamic_cast<TextBlock^>(outputFrame->FindName("BytesTextBlock"));
    Diag::SetBytesTextBlock(bytesblock);
	TextBlock^ cpublock = dynamic_cast<TextBlock^>(outputFrame->FindName("CpuTextBlock"));
    Diag::SetCpuTextBlock(bytesblock);
