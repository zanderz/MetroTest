...
TextBlock^ Diag::debugBytesTextBlock = nullptr;
TextBlock^ Diag::debugCpuTextBlock = nullptr;
TSQueue^ AppContext::messageQueue_ = nullptr;

CommModule::CommModule(AppRole appRole):appRole(appRole), TIMEOUT(30000), MAX_BUFFER_LENGTH(500000), _bytesTotal(0)
{
}
...
bool CommModule::RegisterWithCCT(String^ serverHostName, String^ serverPort, String^ channelId)
{
...
//            ref new ControlChannelTrigger(channelId, serverKeepAliveInterval, ControlChannelTriggerResourceType::RequestHardwareSlot);                
            ref new ControlChannelTrigger(channelId, serverKeepAliveInterval, ControlChannelTriggerResourceType::RequestSoftwareSlot);                
    } 
...
//		String^ channelId = "channelOne";
        ...
        result = RegisterWithCCT(serverHostName, serviceName, "channelOne");
  //      result = RegisterWithCCT(serverHostName, serviceName, "channelTwo");
  //      result = RegisterWithCCT(serverHostName, serviceName, "channelThree");
		//result = RegisterWithCCT(serverHostName, serviceName, "channel4");
		//result = RegisterWithCCT(serverHostName, serviceName, "channel5");
		//result = RegisterWithCCT(serverHostName, serviceName, "channel6");
		//result = RegisterWithCCT(serverHostName, serviceName, "channel7");
		//result = RegisterWithCCT(serverHostName, serviceName, "channel8");
		//result = RegisterWithCCT(serverHostName, serviceName, "channel9");
		//result = RegisterWithCCT(serverHostName, serviceName, "channel10");
		//result = RegisterWithCCT(serverHostName, serviceName, "channel11");
		//result = RegisterWithCCT(serverHostName, serviceName, "channel12");
		//result = RegisterWithCCT(serverHostName, serviceName, "channel13");
		//result = RegisterWithCCT(serverHostName, serviceName, "channel14");
		//result = RegisterWithCCT(serverHostName, serviceName, "channel15");
		//result = RegisterWithCCT(serverHostName, serviceName, "channel16");
		//result = RegisterWithCCT(serverHostName, serviceName, "channel17");
		//result = RegisterWithCCT(serverHostName, serviceName, "channel18");
		//result = RegisterWithCCT(serverHostName, serviceName, "channel19");
		//result = RegisterWithCCT(serverHostName, serviceName, "channel20");
...
void CommModule::OnDataReadCompletion(unsigned int bytesRead, DataReader^ readPacket)
{
	...
	String^ messagePrefix = ref new String(message->Begin(), 10);
    Diag::DebugPrint("Received Buffer : " + messagePrefix + "..." );
